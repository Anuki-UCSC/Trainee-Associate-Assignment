...
export default function HomePage() {
    const [data,setData]=useState([
        // {id:"1",username:"anuki",name:"anuki",email:"anu1@ssgmail.com"},
        // {id:"2",username:"anuki",name:"anuki",email:"anu2@ssgmail.com"},
        // {id:"3",username:"anuki",name:"anuki",email:"anu3@ssgmail.com"},
    ]);
